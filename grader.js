...
var cheerioHtmlBuffer = function(buffer) {
...
var buildfn = function(checks) {
    var response2console = function(result, response) {
	    ...
	    var checkJson = checkHtmlBuffer(result, checks);
...
if(require.main == module) {
	...
	.option('-u, --url <html_url>','URL to index.html', clone(assertUrlExists),URLFILE_DEFAULT)
	.parse(process.argv);
